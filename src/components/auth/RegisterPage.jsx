            ...
            <div className="max-w-md mx-auto w-full space-y-6">
              ...
              <div className="grid grid-cols-2 gap-3 pt-1">
                <button
                  type="button"
                  onClick={() => {
                    setName('Demo Google User');
                    setUsername('google_user');
                    setEmail('demo.google@pingx.com');
                    setPassword('SecurePass123!');
                    addToast('Google credentials pre-filled! Click Create Account.', 'info');
                  }}
                ...
                <button
                  type="button"
                  onClick={() => {
                    setName('Demo Apple User');
                    setUsername('apple_user');
                    setEmail('demo.apple@pingx.com');
                    setPassword('SecurePass123!');
                    addToast('Apple credentials pre-filled! Click Create Account.', 'info');
                  }}
                  className="flex items-center justify-center gap-2.5 py-2.5 px-4 rounded-xl border border-slate-200 bg-white hover:bg-slate-50 text-xs font-bold text-slate-700 transition-colors cursor-pointer"
                >
